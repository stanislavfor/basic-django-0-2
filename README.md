...
- **Если работа с проектом уже проводится, и включено виртуальное окружение, то сразу выполнить [пункт 6](#запустить-локальный-веб).**
...
3. Запустить миграцию базы данных, чтобы убедиться, что база данных синхронизирована с последней версией ваших моделей:
